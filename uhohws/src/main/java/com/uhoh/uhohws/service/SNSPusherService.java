...
import com.uhoh.uhohws.tools.AmazonSNSClientWrapper;
import com.uhoh.uhohws.tools.SampleMessageGenerator.Platform;

public class SNSPusherService {

	private AmazonSNSClientWrapper snsClientWrapper;

	public SNSPusherService(AmazonSNS snsClient) {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("===========================================\n");
		try {
			SNSPusherService sample = new SNSPusherService(sns);
